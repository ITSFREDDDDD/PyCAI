...
#       Managing a chat2 with a character
        ...
        chat.new('CHAR', 'CHAT_ID', 'CREATOR_ID') #may have made a mistake here, it looks like there's a new chat function separate from new message, and I'm not sure if I handled that correctly
